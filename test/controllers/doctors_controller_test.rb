...
class DoctorsControllerTest < ActionController::TestCase
  ...
  test "should create doctor" do
    assert_difference('Doctor.count') do
      post :create, doctor: { name: @doctor.name, pwz_number: @doctor.pwz_number, surname: @doctor.surname }
    end
  ...
  test "should update doctor" do
    patch :update, id: @doctor, doctor: { name: @doctor.name, pwz_number: @doctor.pwz_number, surname: @doctor.surname }
    assert_redirected_to doctor_path(assigns(:doctor))
  end
