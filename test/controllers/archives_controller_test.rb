...
class ArchivesControllerTest < ActionController::TestCase
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post :create, archive: { date: @archive.date, id_appointments: @archive.id_appointments, state: @archive.state }
    end
  ...
  test "should update archive" do
    patch :update, id: @archive, archive: { date: @archive.date, id_appointments: @archive.id_appointments, state: @archive.state }
    assert_redirected_to archive_path(assigns(:archive))
  end
